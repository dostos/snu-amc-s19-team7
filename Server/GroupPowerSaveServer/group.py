...
class Group(object):
    ...
    def __init__(self, _member_id_list : list = []):
        self._id = Group.__get_unique_id()
        self._member_id_list = _member_id_list
        self.__member_id_list_lock = Lock()
    ...
    def confirm_leader_update(self, id):
        ...
        if self._member_id_list[self.__next_leader_index()] == id:
    ...
    def __next_leader_index(self):
        with self.__member_id_list_lock:
            ...
            if next_index == len(self._member_id_list):
                next_index = 0
        return next_index
    ...
    def current_leader_id(self):
        return self._member_id_list[self._leader_index]
